...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, MainInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        redSB = (SeekBar)findViewById(R.id.sb_red);
        greenSB = (SeekBar)findViewById(R.id.sb_green);
        blueSB = (SeekBar)findViewById(R.id.sb_blue);
    ...
    public boolean activeConnection(){
        Log.d(TAG, "activeConnection: Checking for active connection...");
        boolean isConnected = false;
        if(mBluetoothConnection != null){
            isConnected = mBluetoothConnection.isConnected();
        }
        if(isConnected){
            return true;
        }
...
//***remember the conncction will fail and app will crash if you haven't paired first
    ...
    @Override
    public void setText(String valIn) {
        //Log.d(TAG, "setText: RecivedText " + valIn);
    }
}